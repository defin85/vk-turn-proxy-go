...
| Build scripts, packaging, or CI workflows | `docs/build-workflows.md`, relevant OpenSpec change, `Makefile` | `./scripts/build-go-matrix.sh windows/amd64`; `go test ./...`; `go build ./...` | Windows GUI packaging, toolchain pinning, or CI workflow wiring changed |
