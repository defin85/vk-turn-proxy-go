...
| Build scripts, packaging, or CI workflows | `docs/build-workflows.md`, `Makefile`, `openspec/specs/native-build-workflows/spec.md` | `./scripts/build-go-matrix.sh windows/amd64`; `make build-gui-linux`; `make package-gui-linux-deb`; `make smoke-android-embedded-host`; `make ci` |
