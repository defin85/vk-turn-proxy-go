...
| Desktop Flutter shell | `desktop/gui_shell/README.md`, `docs/windows-desktop-wg-poc.md`, `docs/windows-desktop-live-vk-workflow.md`, `desktop/gui_shell/lib`, `openspec/changes/add-02-desktop-gui-shell/*` | `flutter analyze`, `flutter test`, sidecar integration test |
| Mobile Flutter shell | `mobile/gui_shell/README.md`, `docs/android-wg-phone-poc.md`, `mobile/gui_shell/lib`, `openspec/changes/add-03-mobile-gui-shell/*` | `flutter analyze`, `flutter test`, mocked bridge integration test |
