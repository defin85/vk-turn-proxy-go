...
enum PortableTransportProfileImportSource { file, paste, scanQr }
  ...
  return showDialog<PortableTransportProfileImportSource>(
    ...
    builder: (BuildContext context) {
      ...
      return AlertDialog(
        ...
        content: const Text(
          'Choose how to bring the encrypted VPN transport-profile envelope onto this device.',
        ),
        actions: <Widget>[
          TextButton(
          ...
          FilledButton(
            key: const ValueKey<String>(
              'transport-profile-portable-import-source-scan',
            ),
            onPressed: () => Navigator.of(
              context,
            ).pop(PortableTransportProfileImportSource.scanQr),
...
Future<String?> showPortableTransportProfileQrScanner(BuildContext context) {
  return Navigator.of(context).push<String>(
    MaterialPageRoute<String>(
      builder: (BuildContext context) =>
          const _PortableTransportProfileQrScannerPage(),
    ),
  );
}
...
Future<void> showPortableTransportProfileExportDialog({
  ...
  required Future<void> Function() onShareFile,
}) async {
    ...
    builder: (BuildContext context) {
      ...
      return AlertDialog(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (canRenderQr) ...<Widget>[
                  ...
                  _warningBanner(
                    context,
                    copy.portableQrUnavailableMobile(carriage.encodedBytes),
                  ),
                ],
              ],
            ),
        ...
        actions: <Widget>[
          ...
          TextButton(onPressed: onCopyText, child: Text(copy.copyText)),
          FilledButton.tonal(
            onPressed: onShareText,
            child: Text(copy.shareText),
          ),
          FilledButton(onPressed: onShareFile, child: Text(copy.shareFile)),
        ],
      );
    },
  );
...
class _PortableTransportProfileQrScannerPage extends StatefulWidget {
  const _PortableTransportProfileQrScannerPage();

  @override
  State<_PortableTransportProfileQrScannerPage> createState() =>
      _PortableTransportProfileQrScannerPageState();
}

class _PortableTransportProfileQrScannerPageState
    extends State<_PortableTransportProfileQrScannerPage> {
  bool _reported = false;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Scan portable VPN profile QR')),
      body: Stack(
        children: <Widget>[
          MobileScanner(
          ...
          Positioned(
            ...
            child: DecoratedBox(
              ...
              child: const Padding(
                ...
                child: Text(
                  'Point the camera at a portable VPN transport-profile QR code.',
