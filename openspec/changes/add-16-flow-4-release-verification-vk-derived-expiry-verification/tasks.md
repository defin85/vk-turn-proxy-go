...
- [ ] 1.3 Validate `add-16-flow-4-release-verification-vk-derived-expiry-verification` with
      `openspec validate add-16-flow-4-release-verification-vk-derived-expiry-verification --strict --no-interactive`
