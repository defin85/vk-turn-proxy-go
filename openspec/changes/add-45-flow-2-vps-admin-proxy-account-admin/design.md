...
`add-41-flow-2-vps-admin-server-admin-web` scopes the first authenticated browser admin
...
Runtime health and service lifecycle belong to `add-41-flow-2-vps-admin-server-admin-web`.
