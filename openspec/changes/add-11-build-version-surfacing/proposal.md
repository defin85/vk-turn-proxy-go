...
- Define a repo-managed version source plus build metadata stamping for Go binaries and Flutter GUI artifacts.
...
- Affected code: `scripts/build-go-matrix.sh`, `scripts/build-windows-gui-from-wsl.sh`, `scripts/build-gui-windows.ps1`, `cmd/clientd`, `pkg/clientcontrol`, `desktop/gui_shell`, version/build metadata helpers, docs
