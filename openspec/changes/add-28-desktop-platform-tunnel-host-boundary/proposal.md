...
## Why
`add-18-desktop-platform-tunnel-ready-paths` already defines the desktop
...
## Sequence
- Order: `28`
- Depends on: `add-02-desktop-gui-shell`, `add-18-desktop-platform-tunnel-ready-paths`, `add-22-runtime-execution-planning`, `add-23-turn-datagram-wireguard-carrier`
