...
- [ ] 2.3 Update the mobile bridge and mobile GUI shell to surface the typed Android ready and failure states plus explicit app-scope selection, including reconnect-required semantics for later scope changes and resume after Android permission grant, without inferring support from platform heuristics
