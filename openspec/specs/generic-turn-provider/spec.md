# generic-turn-provider Specification

## Purpose
Define the deterministic `generic-turn` provider contract for static TURN credential resolution and sanitized probe artifacts without live provider signaling.
## Requirements
