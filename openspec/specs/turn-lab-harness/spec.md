# turn-lab-harness Specification

## Purpose
Define the reusable local TURN lab harness contract for deterministic transport integration tests and smoke runs without live provider dependencies.
## Requirements
