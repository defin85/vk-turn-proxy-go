...
## Purpose
Define the structured runtime-event and low-cardinality metrics contract for long-running client and server binaries, including startup outcomes, transport failures, worker health, and forwarded traffic.
## Requirements
