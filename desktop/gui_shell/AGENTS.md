...
- Run `dart pub get` from the repository root, then launch the shell with `mcp__dart_desktop__.launch_app(device="linux", root="/home/egor/code/vk-turn-proxy-go/desktop/gui_shell")`.
